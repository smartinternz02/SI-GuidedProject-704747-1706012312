...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Yes'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Medicaid'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/p_30012024'), 0)
