...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'Booked for self')
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_31012024'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Booked for self'))
